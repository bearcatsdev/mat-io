...
exports.reservationForm = (req, res) => {
    ...
    if (!req.recaptcha.error) {
        if (req.recaptcha.data.score >= 0.7) {
            ...
            console.log("captcha failed score: " + req.recaptcha.data.score);
            res.redirect("?error=Captcha verification failed. Are you a robot?");
        }
    } else {
